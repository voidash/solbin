      ...
      <div>
        ...
        <div className=' mt-8 mx-3 h-64' id="home">
          <div className='bg-white rounded-xl h-5/6'>
            <div className='grid grid-cols-2'>
              <div className='mt-5'>
                <Image src='/bin.png' width={200} height={250}/>
              </div>
          ...
          <div className='bg-white rounded-xl '>
            <div className='p-1 h-full'>
              <div className='p-5 grid grid-cols-3 gap-1'>
                <Image src='/bin.png' width={100} height={150}/>
                <div className='w-3/4 m-5'>
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-full w-3/4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
                </div>
                <div className='w-full h-full mt-5'>
                  <Image src='/solana.png' width={100} height={100}/>
                </div>
              </div>
        ...
        <div className='mx-2 mt-5' id="how">
          ...
          <div className='grid place-items-center'>
            ...
            <div class="w-[200px] h-[200px] bg-white rounded-full flex justify-center items-center">
              <div>
                <div>
                  <div className='grid place-items-center'>
            ...
            <div className='w-3/4 m-5 grid place-items-center'>
              <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="#ffffff" stroke-width="4">
                <path stroke-linecap="round" stroke-linejoin="round" d="M20 17l-4 4m0 0l-4-4m4 4V3" />
              </svg>
            </div>
        ...
        <div class="flex justify-center m-4 h-72">
          <div class="block p-4 rounded-lg shadow-lg bg-white max-w-sm">
            <div className='mb-2' style={{width: '100%', height: '50%', position: 'relative'}}>
              <Image src='/assets/decomposable.png' layout='fill' objectFit='contain' />
            </div>
            <h5 class="text-gray-900 text-xl leading-tight font-medium mb-2 mt-2">Decomposable Items Dustbin</h5>
            <p class="text-gray-700 text-base">You can place Decomposable items such as waste food as a feed for livestock, or waste unedible organic material for compost</p>
          </div>
        </div>
        ...
        <div class="flex justify-center m-4 h-72">
          <div class="block p-4 rounded-lg shadow-lg bg-white max-w-sm">
            <div className='mb-2' style={{width: '100%', height: '50%', position: 'relative'}}>
              <Image src='/assets/paper.png' layout='fill' objectFit='contain' />
            </div>
            <h5 class="text-gray-900 text-xl leading-tight font-medium mb-2 mt-2">Paper Dustbin</h5>
        ...
        <div class="flex justify-center m-4 h-72">
          <div class="block p-4 rounded-lg shadow-lg bg-white max-w-sm">
            ...
            <h5 class="text-gray-900 text-xl leading-tight font-medium mb-2 mt-2">Plastics Dustbin</h5>
            <p class="text-gray-700 text-base">You can place Plastics of type ABS and PET such as coke bottles, Water bottles, Other plastics such as polyestere also</p>
          </div>
        </div>
